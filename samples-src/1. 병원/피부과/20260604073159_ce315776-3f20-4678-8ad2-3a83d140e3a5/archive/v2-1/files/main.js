...
function renderChecklistScreen() {
  ...
  const progressText = (textData.checklistProgress || "{done} / {total}").replace("{done}", String(doneCount)).replace("{total}", String(total));
...
function renderQuizScreen() {
  ...
  const handleAns = (ans) => {
    ...
    resultMark.textContent = isCorrect ? textData.correctText || "\uC815\uB2F5\uC774\uC5D0\uC694!" : textData.wrongText || "\uB2E4\uC2DC \uD655\uC778\uD574\uC694";
