...
export const SAMPLE_ITEMS: SampleItem[] = [
  ...
  {
    id: "academy-math",
    title: "수학 공식·연산 체크 스마트 퀴즈",
    description: "수학 공식·연산을 카드·퀴즈로 점검하는 수학학원 콘텐츠",
    demoUrl: "/apps/academy-math/index.html",
    thumbnail: "/apps/academy-math/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-english",
    title: "영어 단어 복습 스마트 카드",
    description: "핵심 영단어를 카드·퀴즈로 익히는 영어학원 콘텐츠",
    demoUrl: "/apps/academy-english/index.html",
    thumbnail: "/apps/academy-english/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-science",
    title: "과학 개념 확인 스마트 콘텐츠",
    description: "핵심 과학 개념을 카드·퀴즈로 점검하는 과학 콘텐츠",
    demoUrl: "/apps/academy-science/index.html",
    thumbnail: "/apps/academy-science/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-korean",
    title: "어휘·문장 이해 스마트 퀴즈",
    description: "어휘·문장 이해를 카드·퀴즈로 익히는 국어·논술 콘텐츠",
    demoUrl: "/apps/academy-korean/index.html",
    thumbnail: "/apps/academy-korean/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-art",
    title: "미술 개념 확인 스마트 퀴즈",
    description: "색과 표현의 기초를 익히는 미술학원 콘텐츠",
    demoUrl: "/apps/academy-art/index.html",
    thumbnail: "/apps/academy-art/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-coding",
    title: "코딩 개념 확인 스마트 퀴즈",
    description: "코딩 핵심 개념을 카드·퀴즈로 익히는 코딩학원 콘텐츠",
    demoUrl: "/apps/academy-coding/index.html",
    thumbnail: "/apps/academy-coding/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-history",
    title: "인물·사건 매칭 스마트 퀴즈",
    description: "역사 인물·사건을 매칭하며 익히는 한국사 콘텐츠",
    demoUrl: "/apps/academy-history/index.html",
    thumbnail: "/apps/academy-history/assets/thumbnail.png",
    category: "학원",
  },
  {
    id: "academy-kids",
    title: "그림 보고 말하기 스마트 학습",
    description: "그림을 보고 말하며 낱말을 익히는 유아·초등 콘텐츠",
    demoUrl: "/apps/academy-kids/index.html",
    thumbnail: "/apps/academy-kids/assets/thumbnail.png",
    category: "학원",
  },
  // 의료
  {
    id: "clinic-dental",
    title: "발치·임플란트 후 관리 스마트 안내",
    description: "발치·임플란트 후 관리 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-dental/index.html",
    thumbnail: "/apps/clinic-dental/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-derma",
    title: "피부 시술 후 관리",
    description: "피부 시술 후 관리 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-derma/index.html",
    thumbnail: "/apps/clinic-derma/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-internal",
    title: "건강검진 전날 체크리스트 스마트 안내",
    description: "건강검진 전날 체크리스트 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-internal/index.html",
    thumbnail: "/apps/clinic-internal/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-animal",
    title: "반려동물 수술·접종 후 관리 스마트 안내",
    description: "반려동물 수술·접종 후 관리 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-animal/index.html",
    thumbnail: "/apps/clinic-animal/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-obgyn",
    title: "임신 초기·산전검사 스마트 안내",
    description: "임신 초기·산전검사 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-obgyn/index.html",
    thumbnail: "/apps/clinic-obgyn/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-pediatric",
    title: "아이 열날 때 대처 스마트 안내",
    description: "아이 열날 때 대처 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-pediatric/index.html",
    thumbnail: "/apps/clinic-pediatric/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-eye",
    title: "안약 사용법·수술 후 주의사항 스마트 안내",
    description: "안약 사용법·수술 후 주의사항 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-eye/index.html",
    thumbnail: "/apps/clinic-eye/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-nursing",
    title: "낙상·욕창 예방 스마트 안내",
    description: "낙상·욕창 예방 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-nursing/index.html",
    thumbnail: "/apps/clinic-nursing/assets/thumbnail.png",
    category: "의료",
  },
  {
    id: "clinic-ortho",
    title: "깁스·수술 후 회복관리 스마트 안내",
    description: "깁스·수술 후 회복관리 스마트 안내 — 환자·보호자 교육 콘텐츠",
    demoUrl: "/apps/clinic-ortho/index.html",
    thumbnail: "/apps/clinic-ortho/assets/thumbnail.png",
    category: "의료",
  },
  // 고객응대·CS
  {
